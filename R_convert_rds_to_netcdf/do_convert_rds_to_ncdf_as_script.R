...
CONDITIONS OF USE:
Please note these data are restricted and may not be on-shared or used for purposes outside the specified project without permission from the data owner." bushfiresmoke_v1_3_%s_compressed.nc

', yy)
#cat(txt)

txt5 <- sprintf('
mv bushfiresmoke_v1_3_%s_compressed.nc ../../data_provided/bushfiresmoke_v1_3_%s_compressed_20230825_1.nc
', yy, yy)
cat(txt)    
#     
# #### example R extract ####   
